                    ...
                    <table class="insert-tab" width="100%" id="fid" cellpadding="0" cellspacing="0">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required-red" id="Introduction" name="introduction" size="20" value="" type="text">
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required-red" id="Score" name="score" size="20" value="" type="text">
                                </td>
                            </tr>
                            <tr>
